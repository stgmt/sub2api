  ...
  admin: {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        haikuModelPlaceholder: 'e.g., gpt-5.3-codex-spark',
    ...
    settings: {
      ...
      openaiFastPolicy: {
        ...
        description: 'Intercept, filter, or pass ChatGPT subscription fast, API priority, and flex requests based on the request body service_tier field. Applies to the OpenAI gateway only.',
        ...
        tierAll: 'All tiers',
        tierFast: 'fast (ChatGPT/Codex subscription)',
        tierPriority: 'priority (API Priority Processing)',
        tierFlex: 'flex',
        action: 'Action',
        actionPass: 'Pass (keep service_tier)',
        actionFilter: 'Filter (remove service_tier)',
        actionForcePriority: 'Force priority (API key)',
