  ...
  admin: {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        haikuModelPlaceholder: '例如: gpt-5.3-codex-spark',
    ...
    settings: {
      ...
      openaiFastPolicy: {
        ...
        description: '基于请求体 service_tier 字段拦截/过滤/透传 ChatGPT 订阅 fast、API priority 与 flex 请求；仅作用于 OpenAI 网关。',
