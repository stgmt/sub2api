...
Assert-Contains $sync 'NoRestart' "The sync must provide a non-disruptive mode"
...
Assert-Contains $sync 'PostgreSQL Cline sync failed' "SQL failures must be reported without dumping credentials"
