...
foreach ($legacyProfileName in @("anthropic-only.v1.json", "anthropic-only.v2.json", "anthropic-only.v3.json", "chatgpt-only.v1.json", "chatgpt-only.v2.json", "chatgpt-only.v3.json", "hybrid-current.v1.json")) {
