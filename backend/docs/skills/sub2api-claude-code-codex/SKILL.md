...
description: >-
  Use this skill for Claude Code through local Headroom + sub2api backed by an OpenAI/Codex/ChatGPT subscription: Docker/WSL and native Ubuntu/Hyper-V setup, host RTK, embedding-server/watchdog, Codex OAuth, GPT-5.6 Sol/Terra/Luna, GPT-5.3 Codex Spark compact routing, Claude model mapping, max reasoning, context fixes, empty streams, stale fake 429/503 cooldowns, adaptive OAuth 403 auto-heal, and model_rate_limits self-heal. Triggers include "Claude Code через Codex подписку", "Headroom sub2api", "sub2api Docker", "RTK на Ubuntu", "Hyper-V Claude Code", "install-claude-rtk.sh", "embedding-server", "SocketEmbedderClient", "Falling back to per-worker embedder", "gpt-5.6-sol", "gpt-5.6-terra", "gpt-5.6-luna", "gpt-5.5[400k]", "быстрая компактизация", "gpt-5.3-codex-spark", "usage 0/0", "403 Access forbidden", "503 Service temporarily unavailable", "429 rate_limit_error", and "no available accounts".
---
